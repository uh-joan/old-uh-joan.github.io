$(document).ready(function(){
    ...
    $(".onepage-pagination").children().each(function(){
        switch($(this).children().data("index"))
        {
            ...
            case 3:$(this).children().append("<i class='entypo-dot'></i>");break;
    ...
    setInterval(function(){
        ...
        if(c==true&&b==false){
            ...
            $(".slide-3").css("background","#34495e");b=true;
        }
    },300);
    ...
    $(".toggle-slide-fade").on("click",function(){if(c===false){c=true;console.log(c);
    }
    else{
        if(c===true){
